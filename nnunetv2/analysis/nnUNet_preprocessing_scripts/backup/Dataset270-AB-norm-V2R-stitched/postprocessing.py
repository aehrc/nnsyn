...
if __name__ == '__main__':
    ...
    # config = json.load(open(os.path.join(cur_file_path, "config_270__nnUNetTrainerMRCT__nnUNetPlans__3d_fullres.json")))
    # analyze_validation(config)
    # config = json.load(open(os.path.join(cur_file_path, "config_272__nnUNetTrainerMRCT__nnUNetPlans__3d_fullres.json")))
    # analyze_validation(config)
    config = json.load(open(os.path.join(cur_file_path, "config_274__nnUNetTrainerMRCT__nnUNetPlans__3d_fullres.json")))
    analyze_validation(config)
