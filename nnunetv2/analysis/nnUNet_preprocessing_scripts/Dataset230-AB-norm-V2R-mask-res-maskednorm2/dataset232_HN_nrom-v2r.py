...
if __name__ == '__main__':
    ...
    config = {
        ...
        "dataset_data_name": f"synthrad2025_task1_MR_{REGION}_pre_v2r_stitched_masked_both_pre",
        "dataset_target_name": f"synthrad2025_task1_CT_{REGION}_pre_v2r_stitched_masked_both_pre",
        ...
        "preprocessing_MRI": "zscore_masked",
