...
if __name__ == '__main__':
    ...
    REGION = "AB"
    config = {
        "dataset_id": 290,  # Updated to 200 for CT noNorm
    ...
    print("Preprocessed data moved to:", nnunet_targets_preprocessed_dir)
    ...
    print("Masks moved to:", dataset_mask_path)
    print("Ground truth targets moved to:", dataset_target_path2)
    # train the network
