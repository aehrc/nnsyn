...
if __name__ == '__main__':
    ...
    SOURCE_DATASET_ID = 261 # synthetic CT dataset
    config = {
        "dataset_id": DATASET_ID,  # Updated to 200 for CT noNorm
        "dataset_data_name": f"SEGMENTATION_synthrad2025_task1_CT_{REGION}_aligned_to_Dataset261",
    ...
    TARGET_PLAN_IDENTIFIER = config["plan"] + '_Dataset261'
