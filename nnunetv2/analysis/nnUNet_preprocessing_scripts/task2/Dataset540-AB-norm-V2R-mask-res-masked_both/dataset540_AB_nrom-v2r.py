...
if __name__ == '__main__':
    ...
    config = {
        ...
        "dataset_data_name": f"synthrad2025_task{TASK}_CBCT_{REGION}_pre_v2r_stitched_masked_both",
        "dataset_target_name": f"synthrad2025_task{TASK}_CT_{REGION}_pre_v2r_stitched_masked_both",
