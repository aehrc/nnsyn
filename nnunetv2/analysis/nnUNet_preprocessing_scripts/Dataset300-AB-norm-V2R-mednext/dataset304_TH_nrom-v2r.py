...
if __name__ == '__main__':
    ...
    REGION = "TH"
    config = {
        "dataset_id": 304,  # Updated to 200 for CT noNorm
    ...
    move_preprocessed(nnunet_datas_preprocessed_dir, nnunet_targets_preprocessed_dir, plan=config["plan"], configuration=config["configuration"])
