...
cd /datasets/work/hb-synthrad2023/work/synthrad2025/bw_workplace/ref/evaluation/
srun python /datasets/work/hb-synthrad2023/work/synthrad2025/bw_workplace/ref/evaluation/pred_gt_seg.py --region TH
