...
mkdir -p ${save_path}
nnUNetv2_export_model_to_zip -d $DATASET_ID -o ${save_path}/dataset${DATASET_ID}_fold0-5.zip -c 3d_fullres -tr nnUNetTrainerMRCT_loss_masked_perception_masked -f 0 1 2 3 4 -p nnUNetResEncUNetLPlans
