...
class SSIMLoss(_Loss):
    ...
    def forward(self, input: torch.Tensor, target: torch.Tensor, mask=None) -> torch.Tensor:
        """
        Args:
            ...
            mask: binary mask with shape (batch_size, channels, spatial_dim1, spatial_dim2[, spatial_dim3])
