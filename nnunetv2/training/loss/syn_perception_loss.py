...
class SynPerceptionLoss(nn.Module):
    ...
    def _load_trained_segmentor(self, region: str):
        segmentor_training_output_dir = {
            ...
            "TH": "/datasets/work/hb-synthrad2023/work/synthrad2025/bw_workplace/data/nnunet_struct/results/Dataset802_SEGMENTATION_synthrad2025_task1_CT_TH_aligned_to_Dataset264/nnUNetTrainer__nnUNetResEncUNetLPlans_Dataset265__3d_fullres"
        }
...
if __name__ == "__main__":
    # Example usage
    region = "AB"  # or "HN", "TH"
    syn_perception_loss = SynPerceptionLoss_L2(region, image_loss_weight=0.5)
